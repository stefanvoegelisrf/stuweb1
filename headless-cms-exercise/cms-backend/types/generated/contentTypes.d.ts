...
export interface ApiShoeVariationShoeVariation
  extends Struct.CollectionTypeSchema {
  collectionName: 'shoe_variations';
  info: {
  ...
  attributes: {
    ProductImages: Schema.Attribute.Media<
      ...
      true
    >;
    shoe: Schema.Attribute.Relation<'oneToOne', 'api::shoe.shoe'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shoe-variation.shoe-variation'
    >;
  };
}
